...
from model.deeplabv2_multitask import Res_Deeplab
...
def main():
    ...
    for i_iter in range(start_iteration, num_iterations):
        ...
        pred = interp(out["S"])
        predD = interp(out["D"])
        L_l = loss_calc(pred, labels) + 0.01 * loss_depth_calc(predD, depth)# Cross entropy loss for labeled data
